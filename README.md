...
3. Buat nama project flutter hello_world
   <img width="863" height="234" alt="image" src="https://github.com/user-attachments/assets/32ebda0e-5925-4490-be9a-8c307987ecc9" />
4. Project flutter berhasil dibuat
<img width="940" height="538" alt="image" src="https://github.com/user-attachments/assets/65e3e8f6-b85c-42d6-9ee0-1032c50b051c" />
   
#Praktikum 2: Menghubungkan Perangkat Android atau Emulator#
Menjalankan aplikasi di perangkat Android menggunakan Wi-Fi dengan menghubungkan perangkat Android dan komputer ke jaringan yang sama
1. Membuka project hello_world di android studio
   <img width="840" height="493" alt="image" src="https://github.com/user-attachments/assets/e4a4a2b6-9533-4a69-9933-382a3abad736" />
2. pilih device using wifi
   <img width="707" height="549" alt="image" src="https://github.com/user-attachments/assets/fac77cb1-82d2-423a-a950-b1e13abcf998" />
3. aktifkan Mode Developer pada device yang akan digunakan
   <img width="448" height="735" alt="image" src="https://github.com/user-attachments/assets/e2f6f232-b9be-48f4-ad7d-b4995d9e0960" />
4. lakukan scan qr tersebut
   <img width="768" height="716" alt="image" src="https://github.com/user-attachments/assets/ff95052b-f618-4be1-b1bc-298073cfdfc7" />
5. disini saya menggunakan Samsung A55
   <img width="739" height="828" alt="image" src="https://github.com/user-attachments/assets/d63b1325-f6f2-4fac-a8dc-28265e2e7884" />
6. Masukan perintah flutter run pada terminal
